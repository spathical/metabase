...
(defproject metabase "metabase-SNAPSHOT"
  ...
  :profiles {:dev {:dependencies [[org.clojure/tools.nrepl "0.2.12"]  ; REPL <3
             ...
             :uberjar {:aot :all
                       :jvm-opts ["-Dmanifold.disable-jvm8-primitives=true"]}           ; disable Manifold Java 8 primitives, breaks Java 7 support (see https://github.com/ztellman/manifold#java-8-extensions)
